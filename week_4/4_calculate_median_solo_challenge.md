# U1.W3: Calculate the Median - SOLO CHALLENGE

**Refer to [Solo Challenge](https://github.com/Devbootcamp/phase_0_handbook/blob/master/solo_challenges.md) for guidelines**
